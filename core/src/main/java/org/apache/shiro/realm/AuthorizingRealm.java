...
/**
 * An {@code AuthorizingRealm} extends the {@code AuthenticatingRealm}'s capabilities by adding Authorization (access control) support.
 * {@code AuthorizingRealm}通过添加授权（访问控制）支持来扩展{@code AuthorizingRealm}的功能。
