...
public abstract class AuthenticatingRealm extends CachingRealm implements Initializable {
    ...
    /**
     * 如果{@link CacheManager}已启用，则应使用身份验证缓存，则返回{@code true}
     * <p>
     * *{@link#设置缓存管理器(org.apache.shiro.缓存管理器)配置}，{@code false}否则。
     * <p>
     * *<p/>
     * <p>
     * *默认值是{@code true}。
    ...
    /**
     * 返回与指定令牌或{@code null}对应的任何缓存AuthenticationInfo（如果当前没有任何缓存数据）。
